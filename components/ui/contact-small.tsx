import { PhoneIcon, EnvelopeIcon } from '@heroicons/react/24/outline'; // Updated import path
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg/8 text-gray-600">
            Feel free to reach out if you have any questions or if you are ready to book your first lesson.
          </p>
        </div>
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base/7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none">
          <a href="tel:+448002465099">
          ...
          {/* <a href="https://wa.me/447838457086">
            <div className='hover:bg-gray-200 rounded-lg'>
              <h3 className="border-l border-indigo-600 pl-6 font-semibold text-gray-900">WhatsApp</h3>
              <address className="border-l border-gray-200 pl-6 pt-2 not-italic text-gray-600">
                <div className="flex items-center space-x-4">

                  <svg width="1.5rem" height="1.5rem" viewBox="0 0 360 362" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="mailto:contact@middlesbroughmusicacademy.co.uk">
            <div className='hover:bg-gray-200 rounded-lg'>
              <h3 className="border-l border-indigo-600 pl-6 font-semibold text-gray-900">Email</h3>
              <address className="border-l border-gray-200 pl-6 pt-2 not-italic text-gray-600">
                <div className="flex items-center space-x-4">
                  <EnvelopeIcon className="h-6 w-6 text-gray-500" />
                  <p>contact@middlesbroughmusicacademy.co.uk</p>
                </div>
              </address>
            </div>
          </a>
