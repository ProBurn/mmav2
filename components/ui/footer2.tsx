      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-16 grid md:grid-cols-3 xl:grig-cols-4 gap-8 xl:col-span-3 xl:mt-0">
              {/* <div className="md:grid md:grid-cols-2 md:gap-8"> */}
                {/* <div>
                  <h3 className="text-sm/6 font-semibold text-gray-900">Lessons</h3>
                ...
                <div className=" md:mt-0 col-start-1 xl:col-start-1">
                  <h3 className="text-sm/6 font-semibold text-gray-900 ">Lessons</h3>
                  <ul role="list" className="mt-6 space-y-4">
                    {navigation.lessons.map((item) => (
                      <li key={item.name}>
