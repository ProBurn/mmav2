                            ...
                            <dl className="mt-16 grid grid-cols-1 gap-x-8 gap-y-12 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mt-28 lg:grid-cols-4">
                                {stats.map((stat, statIdx) => (
                                    <div key={statIdx} className="flex flex-col-reverse gap-y-3 border-l border-black/20 dark:border-white/20 pl-6">
                                        ...
                                        <CountUp as="dd" formatThousands={false} target={stat.value} suffix={stat.suffix ?? ''} className="text-3xl font-semibold tracking-tight text-black dark:text-white" />
                                    </div>
                                ))}
                            </dl>
                        </div>
                    ...
                    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                            ...
                            {products.map((product, index) => (
                                ...
                                <AnimateIn key={`productid${index}`} delay={0.2 + index * 0.2} className="group relative">
                                    <img
