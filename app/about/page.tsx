...
// ]
const stats = [
  { label: 'Hours of lessons taught since inception', value: 44, suffix: 'million' },
  { label: `Hairs on Chris Meek's head`, value: 119, suffix: 'trillion' },
  { label: 'New students annually', value: 46000 },
]
                ...
                <div className="lg:flex lg:flex-auto lg:justify-center">
                  <dl className="w-64 space-y-8 xl:w-80">
                    {stats.map((stat, index) => (
                      <AnimateIn key={stat.label} delay={0.2 + index * 0.2} className="flex flex-col-reverse gap-y-4">
                        <dt className="text-base/7 text-gray-600">{stat.label}</dt>
                        <CountUp as="dd" target={stat.value} suffix={` ${stat.suffix ?? ''}`} className="text-5xl font-semibold tracking-tight text-gray-900" />
                      </AnimateIn>
                    ))}
                  </dl>
                </div>
          ...
          <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
            ...
            <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base/7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              {values.map((value, index) => (
                <AnimateIn key={value.name} delay={0.2 + index * 0.2}>
            ...
            >
              {team.map((person, index) => (
                ...
                >
                  ...
                  <img alt="" src={person.imageUrl} className="mx-auto size-24 rounded-full object-cover" />
